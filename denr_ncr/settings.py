"""
Django settings for denr_ncr project.
...
SECRET_KEY = 'django-insecure-fay7ugynopq=21k=e_dtsk!g*y5vx-8dxl3ddfz)bym9p2eksm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'payslip_generation_system.context_processors.global_user_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'denr_ncr.wsgi.application'
